...
<div style="border: 2px solid #d1d5db; padding: 20px; border-radius: 8px; background-color: #f9fafb;">
  ...
  <p align="center">
    ...
    <a href="https://github.com/aslater3/ProxmoxVE/blob/main/.github/CONTRIBUTING.md">
      <img src="https://img.shields.io/badge/Contribute-ff4785?style=for-the-badge&logo=git&logoColor=white" alt="Contribute" />
    </a> 
    <a href="https://github.com/aslater3/ProxmoxVE/blob/main/USER_SUBMITTED_GUIDES.md">
      <img src="https://img.shields.io/badge/Guides-0077b5?style=for-the-badge&logo=read-the-docs&logoColor=white" alt="Guides" />
    </a> 
    <a href="https://github.com/aslater3/ProxmoxVE/blob/main/CHANGELOG.md">
...
- **GitHub Discussions**: [Ask questions or report issues](https://github.com/aslater3/ProxmoxVE/discussions).

## 🤝 Report a Bug or Feature Request

If you encounter any issues or have suggestions for improvement, file a new issue on our [GitHub issues page](https://github.com/aslater3/ProxmoxVE/issues). You can also submit pull requests with solutions or enhancements!
