...
```bash
source <(curl -s https://raw.githubusercontent.com/aslater3/ProxmoxVE/main/misc/build.func)
```

> [!CAUTION]
> Before opening a Pull Request, change the URLs to point to the aslater3 repo.
