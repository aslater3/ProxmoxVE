...
export const navbarLinks = [
	{
		href: `https://github.com/aslater3/${basePath}`,
		event: "Github",
	...
	{
		href: `https://github.com/aslater3/${basePath}/blob/main/CHANGELOG.md`,
		event: "Change Log",
	...
	{
		href: `https://github.com/aslater3/${basePath}/discussions`,
		event: "Discussions",
